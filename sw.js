...
// Version: 6.4.2-RC5 PREMIUM VISUAL REFRESH
// ============================================================
const CACHE_NAME = 'ps-cafe-v6.4.2-rc5';
const OFFLINE_URL = './index.html?v=6.4.2-rc5';
const PRECACHE_ASSETS = [
  './', './index.html?v=6.4.2-rc5', './manifest.json?v=6.4.2-rc5',
