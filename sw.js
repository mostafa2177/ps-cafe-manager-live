...
// Version: 6.4.2-RC5.13 OPEN SESSION BILLING INVOICE POLISH
// ============================================================
const CACHE_NAME = 'ps-cafe-v6.4.2-rc5-13';
const OFFLINE_URL = './index.html?v=6.4.2-rc5-13';
const PRECACHE_ASSETS = [
  './', './index.html?v=6.4.2-rc5-13', './manifest.json?v=6.4.2-rc5-13',
