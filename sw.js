...
// Version: 6.4.2-RC5.16 SAFE SESSION RESTORE GUARD
// ============================================================
const CACHE_NAME = 'ps-cafe-v6.4.2-rc5-16';
const OFFLINE_URL = './index.html?v=6.4.2-rc5-16';
const PRECACHE_ASSETS = [
  './', './index.html?v=6.4.2-rc5-16', './manifest.json?v=6.4.2-rc5-16',
