...
// Version: 6.4.2-RC5.5 OPEN SESSION TIMER ALERT LOGIC
// ============================================================
const CACHE_NAME = 'ps-cafe-v6.4.2-rc5-5';
const OFFLINE_URL = './index.html?v=6.4.2-rc5-5';
const PRECACHE_ASSETS = [
  './', './index.html?v=6.4.2-rc5-5', './manifest.json?v=6.4.2-rc5-5',
