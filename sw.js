...
// Version: 6.4.2-RC5.21.0 PREMIUM UI ABSOLUTE POLISH
// ============================================================
const CACHE_NAME = 'ps-cafe-v6.4.2-rc5-21-0';
const OFFLINE_URL = './index.html?v=6.4.2-rc5-21-0';
const PRECACHE_ASSETS = [
  './', './index.html?v=6.4.2-rc5-21-0', './manifest.json?v=6.4.2-rc5-21-0',
