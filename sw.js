...
// Version: 6.4.2 EC3 EC11 RESTORE EC3 STABLE
// ============================================================
const CACHE_NAME = 'ps-cafe-v6.4.2-ec11';
const OFFLINE_URL = './index.html?v=6.4.2-ec11';
const PRECACHE_ASSETS = [
  './', './index.html?v=6.4.2-ec11', './manifest.json?v=6.4.2-ec11',
