...
// Version: 6.4.2-RC5.12 REAL PS DEVICE ICON POLISH
// ============================================================
const CACHE_NAME = 'ps-cafe-v6.4.2-rc5-12';
const OFFLINE_URL = './index.html?v=6.4.2-rc5-12';
const PRECACHE_ASSETS = [
  './', './index.html?v=6.4.2-rc5-12', './manifest.json?v=6.4.2-rc5-12',
