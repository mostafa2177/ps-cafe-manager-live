...
// Version: 6.4.2 EC3 OWNER TOOLS LOCK
// ============================================================
const CACHE_NAME = 'ps-cafe-v6.4.2-ec3';
const OFFLINE_URL = './index.html?v=6.4.2-ec3';
const PRECACHE_ASSETS = [
  './', './index.html?v=6.4.2-ec3', './manifest.json?v=6.4.2-ec3',
