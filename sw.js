...
// Version: 6.4.2 EC5 OWNER TOOLS LOCK
// ============================================================
const CACHE_NAME = 'ps-cafe-v6.4.2-ec5';
const OFFLINE_URL = './index.html?v=6.4.2-ec5';
const PRECACHE_ASSETS = [
  './', './index.html?v=6.4.2-ec5', './manifest.json?v=6.4.2-ec5',
