...
// Version: 6.4.2 EC1 COMPACT DASHBOARD
// ============================================================
const CACHE_NAME = 'ps-cafe-v6.4.2-ec1';
const OFFLINE_URL = './index.html?v=6.4.2-ec1';
const PRECACHE_ASSETS = [
  './', './index.html?v=6.4.2-ec1', './manifest.json?v=6.4.2-ec1',
