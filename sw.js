...
// Version: 6.4.2-RC7.6 MOBILE DEVICE STATUS POLISH
// ============================================================
const CACHE_NAME = 'ps-cafe-v6.4.2-rc7-6';
const OFFLINE_URL = './index.html?v=6.4.2-rc7-6';
const PRECACHE_ASSETS = [
  './', './index.html?v=6.4.2-rc7-6', './manifest.json?v=6.4.2-rc7-6',
