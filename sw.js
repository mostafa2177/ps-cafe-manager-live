...
// Version: 6.4.2 EC2 STABLE OWNER TOOLS
// ============================================================
const CACHE_NAME = 'ps-cafe-v6.4.2-ec2';
const OFFLINE_URL = './index.html?v=6.4.2-ec2';
const PRECACHE_ASSETS = [
  './', './index.html?v=6.4.2-ec2', './manifest.json?v=6.4.2-ec2',
