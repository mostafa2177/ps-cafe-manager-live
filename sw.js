...
// Version: 6.4.2-RC5.10 MINI DEVICE HOME CARDS
// ============================================================
const CACHE_NAME = 'ps-cafe-v6.4.2-rc5-10';
const OFFLINE_URL = './index.html?v=6.4.2-rc5-10';
const PRECACHE_ASSETS = [
  './', './index.html?v=6.4.2-rc5-10', './manifest.json?v=6.4.2-rc5-10',
