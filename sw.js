...
// Version: 6.4.2 EC9 SYNC STABLE ROLLBACK
// ============================================================
const CACHE_NAME = 'ps-cafe-v6.4.2-ec9';
const OFFLINE_URL = './index.html?v=6.4.2-ec9';
const PRECACHE_ASSETS = [
  './', './index.html?v=6.4.2-ec9', './manifest.json?v=6.4.2-ec9',
