...
// Version: 6.4.2-RC5.6 DEVICE STATUS COLOR ALERT BLINK
// ============================================================
const CACHE_NAME = 'ps-cafe-v6.4.2-rc5-6';
const OFFLINE_URL = './index.html?v=6.4.2-rc5-6';
const PRECACHE_ASSETS = [
  './', './index.html?v=6.4.2-rc5-6', './manifest.json?v=6.4.2-rc5-6',
