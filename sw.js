...
// Version: 6.4.2 EC4 OWNER TOOLS LOCK
// ============================================================
const CACHE_NAME = 'ps-cafe-v6.4.2-ec4';
const OFFLINE_URL = './index.html?v=6.4.2-ec4';
const PRECACHE_ASSETS = [
  './', './index.html?v=6.4.2-ec4', './manifest.json?v=6.4.2-ec4',
