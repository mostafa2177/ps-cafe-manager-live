...
// Version: 6.4.1 EC6 MATCH ADD-ONS
// ============================================================
const CACHE_NAME = 'ps-cafe-v6.4.1-ec6';
const OFFLINE_URL = './index.html?v=6.4.1-ec6';
const PRECACHE_ASSETS = [
  './', './index.html?v=6.4.1-ec6', './manifest.json?v=6.4.1-ec6',
