...
// Version: 6.4.2-RC5.18.8 TIMED SESSION RPC COMPATIBILITY FIX
// ============================================================
const CACHE_NAME = 'ps-cafe-v6.4.2-rc5-18-8';
const OFFLINE_URL = './index.html?v=6.4.2-rc5-18-8';
const PRECACHE_ASSETS = [
  './', './index.html?v=6.4.2-rc5-18-8', './manifest.json?v=6.4.2-rc5-18-8',
