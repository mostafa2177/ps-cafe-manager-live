...
// Version: 6.4.2-RC2 SAFE UX COMPLETION
// ============================================================
const CACHE_NAME = 'ps-cafe-v6.4.2-rc2';
const OFFLINE_URL = './index.html?v=6.4.2-rc2';
const PRECACHE_ASSETS = [
  './', './index.html?v=6.4.2-rc2', './manifest.json?v=6.4.2-rc2',
