...
// Version: 6.4.1 EC5 MATCH ADD-ONS
// ============================================================
const CACHE_NAME = 'ps-cafe-v6.4.1-ec5';
const OFFLINE_URL = './index.html?v=6.4.1-ec5';
const PRECACHE_ASSETS = [
  './', './index.html?v=6.4.1-ec5', './manifest.json?v=6.4.1-ec5',
