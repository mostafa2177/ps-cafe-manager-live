...
// Version: 6.4.2 EC8 PRICING LOGIC & COMPACT CHOICES
// ============================================================
const CACHE_NAME = 'ps-cafe-v6.4.2-ec8';
const OFFLINE_URL = './index.html?v=6.4.2-ec8';
const PRECACHE_ASSETS = [
  './', './index.html?v=6.4.2-ec8', './manifest.json?v=6.4.2-ec8',
