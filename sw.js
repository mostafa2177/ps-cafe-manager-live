...
// Version: 6.4.2-RC5.17 SAFE SESSION RESTORE GUARD
// ============================================================
const CACHE_NAME = 'ps-cafe-v6.4.2-rc5-17';
const OFFLINE_URL = './index.html?v=6.4.2-rc5-17';
const PRECACHE_ASSETS = [
  './', './index.html?v=6.4.2-rc5-17', './manifest.json?v=6.4.2-rc5-17',
