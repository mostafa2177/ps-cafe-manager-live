...
// Version: 6.4.2-RC1 CLOUD RECOVERY CLEAN
// ============================================================
const CACHE_NAME = 'ps-cafe-v6.4.2-rc1';
const OFFLINE_URL = './index.html?v=6.4.2-rc1';
const PRECACHE_ASSETS = [
  './', './index.html?v=6.4.2-rc1', './manifest.json?v=6.4.2-rc1',
