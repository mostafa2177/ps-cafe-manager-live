...
// Version: 6.4.1 EC9 DAILY USE POLISH
// ============================================================
const CACHE_NAME = 'ps-cafe-v6.4.1-ec9';
const OFFLINE_URL = './index.html?v=6.4.1-ec9';
const PRECACHE_ASSETS = [
  './', './index.html?v=6.4.1-ec9', './manifest.json?v=6.4.1-ec9',
